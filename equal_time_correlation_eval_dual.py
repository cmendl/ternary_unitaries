"""
Evaluate equal-time correlation functions for various operator distances for a
time evolution governed by dual unitary 4-qudit operators.
"""
...
def main():
    ...
    # save data to disk
    with h5py.File(f"data/equal_time_correlation_dual_{seed}.hdf5", "w") as f:
        # MPU tensor of ring
